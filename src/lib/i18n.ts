...
const dict: Record<string, Record<Lang, string>> = {
  ...
  // ===== YouTube HomePage =====
  "yt.hero.title1": { fr: "Boost ta vidéo", en: "Boost your video" },
  "yt.hero.subtitle1": { fr: "Colle le lien de ta vidéo et choisis tes packs", en: "Paste your video link and choose your packs" },
  "yt.hero.subtitle2": { fr: "Vues, likes et abonnés — résultats rapides", en: "Views, likes and subscribers — fast results" },
  "yt.hero.cta": { fr: "Boost ma vidéo →", en: "Boost my video →" },
  "yt.howItWorks.step1.title": { fr: "Colle ton lien", en: "Paste your link" },
  "yt.howItWorks.step1.desc": { fr: "Le lien de ta vidéo YouTube.", en: "Your YouTube video link." },
  "yt.howItWorks.step2.title": { fr: "Choisis ton pack", en: "Choose your pack" },
  "yt.howItWorks.step2.desc": { fr: "Vues, likes ou abonnés — à toi de choisir.", en: "Views, likes or subscribers — your choice." },
  "yt.howItWorks.step3.title": { fr: "Vois les résultats", en: "See the results" },
  "yt.howItWorks.step3.desc": { fr: "Croissance visible directement sur ta vidéo.", en: "Growth visible directly on your video." },
  "yt.faq.q1": { fr: "Est-ce que c'est sûr pour ma chaîne ?", en: "Is it safe for my channel?" },
  "yt.faq.a1": { fr: "Oui. Aucun mot de passe requis, aucun accès à ton compte Google. On a juste besoin du lien de ta vidéo.", en: "Yes. No password required, no access to your Google account. We just need your video link." },
  "yt.faq.q2": { fr: "En combien de temps je vois des résultats ?", en: "How quickly will I see results?" },
  "yt.faq.a2": { fr: "Les premiers résultats sont visibles en quelques heures. Selon le pack choisi, tout est finalisé sous 24-72h.", en: "First results visible within hours. Depending on the pack chosen, everything is finalized within 24-72h." },
  "yt.faq.q3": { fr: "Et si je ne suis pas satisfait ?", en: "What if I'm not satisfied?" },
  "yt.faq.a3": { fr: "Notre équipe est joignable à support@fanovaly.com pour toute question ou ajustement.", en: "Our team is reachable at support@fanovaly.com for any questions or adjustments." },
