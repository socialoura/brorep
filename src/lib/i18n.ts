...
const dict: Record<string, Partial<Record<Lang, string>>> = {
  ...
  // ===== Spotify =====
  "spotify.aiBadge": { fr: "Portée virale propulsée par l'IA", en: "AI-Powered Viral Reach", es: "Alcance viral potenciado por IA", pt: "Alcance viral impulsionado por IA", de: "KI-gestützte virale Reichweite" },
  ...
  "spotify.subtitle1": { fr: "Notre IA cible de vrais auditeurs qui adorent ton style et débloque une meilleure visibilité algorithmique.", en: "Our AI targets real listeners who love your style and unlocks better algorithm visibility.", es: "Nuestra IA dirige tu música a oyentes reales que aman tu estilo y desbloquea mejor visibilidad algorítmica.", pt: "Nossa IA direciona ouvintes reais que amam seu estilo e melhora sua visibilidade algorítmica.", de: "Unsere KI findet echte Hörer, die deinen Stil lieben, und verbessert deine Algorithmus-Sichtbarkeit." },
  "spotify.subtitle2": { fr: "Mets ton morceau devant l'audience parfaite — sélectionnée par IA, engagée, 100% naturelle.", en: "Get your track in front of the perfect audience — AI-selected, engaged, 100% natural.", es: "Pon tu canción frente a la audiencia perfecta — seleccionada por IA, comprometida, 100% natural.", pt: "Coloque sua música diante do público perfeito — selecionado por IA, engajado, 100% natural.", de: "Bring deinen Track vor das perfekte Publikum — KI-ausgewählt, engagiert, 100% natürlich." },
  ...
  "spotify.howItWorks.step1.title": { fr: "L'IA analyse ton morceau", en: "AI analyzes your track", es: "La IA analiza tu tema", pt: "A IA analisa sua música", de: "Die KI analysiert deinen Track" },
  "spotify.howItWorks.step1.desc": { fr: "Colle ton lien Spotify. Notre IA identifie ton genre, ton énergie et les auditeurs les plus susceptibles d'accrocher à ton son.", en: "Paste your Spotify link. Our AI identifies your genre, energy and the listeners most likely to connect with your sound.", es: "Pega tu enlace de Spotify. Nuestra IA identifica tu género, energía y los oyentes con más probabilidades de conectar con tu sonido.", pt: "Cole seu link do Spotify. Nossa IA identifica seu gênero, energia e os ouvintes com mais chance de se conectar com seu som.", de: "Füge deinen Spotify-Link ein. Unsere KI erkennt dein Genre, deine Energie und die Hörer, die am ehesten anspringen." },
  "spotify.howItWorks.step2.title": { fr: "Ciblage IA de ta campagne", en: "AI-powered targeting", es: "Segmentación IA de tu campaña", pt: "Segmentação IA da sua campanha", de: "KI-gesteuertes Targeting" },
  "spotify.howItWorks.step2.desc": { fr: "Choisis la taille de campagne. L'IA match ton morceau avec de vrais auditeurs affinitaires pour une portée virale maximale.", en: "Choose your campaign size. Our AI matches your track with real affinity listeners for maximum viral reach.", es: "Elige el tamaño de tu campaña. La IA empareja tu tema con oyentes reales afines para máxima viralidad.", pt: "Escolha o tamanho da campanha. A IA combina sua música com ouvintes reais afins para alcance viral máximo.", de: "Wähle die Kampagnengröße. Die KI bringt deinen Track zu echten, affinen Hörern — für maximale virale Reichweite." },
  ...
  "spotify.faq.q1": { fr: "Comment fonctionne le ciblage IA ?", en: "How does the AI targeting work?", es: "¿Cómo funciona la segmentación IA?", pt: "Como funciona a segmentação IA?", de: "Wie funktioniert das KI-Targeting?" },
  "spotify.faq.a1": { fr: "Notre IA analyse ton morceau (genre, énergie, artistes similaires) et identifie les vrais comptes Spotify les plus susceptibles d'accrocher. Écoute naturelle et progressive pour respecter l'algorithme.", en: "Our AI analyzes your track (genre, energy, similar artists) and identifies the real Spotify accounts most likely to connect with it. Natural and progressive listening that respects the algorithm.", es: "Nuestra IA analiza tu tema (género, energía, artistas similares) e identifica las cuentas reales de Spotify con más probabilidad de enganchar. Escucha natural y progresiva que respeta el algoritmo.", pt: "Nossa IA analisa sua música (gênero, energia, artistas similares) e identifica as contas reais do Spotify com maior chance de engajar. Escuta natural e progressiva que respeita o algoritmo.", de: "Unsere KI analysiert deinen Track (Genre, Energie, ähnliche Künstler) und findet die echten Spotify-Konten, die am ehesten anspringen. Natürliches, progressives Hören, das den Algorithmus respektiert." },
