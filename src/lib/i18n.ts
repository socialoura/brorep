...
const dict: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "ig.hero.subtitle1": { fr: "Followers, likes et vues de qualité pour", en: "Quality followers, likes and views for", es: "Seguidores, likes y vistas de calidad para", pt: "Seguidores, likes e views de qualidade para", de: "Hochwertige Follower, Likes und Views für" },
  "ig.hero.subtitle2": { fr: "booster ton compte Instagram rapidement", en: "boosting your Instagram account quickly", es: "impulsar tu cuenta de Instagram rápidamente", pt: "impulsionar sua conta do Instagram rapidamente", de: "schnelles Boosten deines Instagram-Kontos" },
  "ig.hero.cta": { fr: "Booster mon compte →", en: "Boost my account →", es: "Impulsar mi cuenta →", pt: "Impulsionar minha conta →", de: "Mein Konto boosten →" },
  "ig.hero.morePercent": { fr: "30% plus", en: "30% more", es: "30% más", pt: "30% mais", de: "30% mehr" },
  "ig.hero.moreProfiles": { fr: "de comptes boostés par notre IA qu'hier", en: "accounts boosted by our AI than yesterday", es: "más cuentas impulsadas por nuestra IA que ayer", pt: "mais contas impulsionadas pela nossa IA que ontem", de: "mehr Konten von unserer KI geboostet als gestern" },
  "ig.howItWorks.step1.title": { fr: "Entre ton @pseudo", en: "Enter your @username", es: "Ingresa tu @usuario", pt: "Digite seu @usuário", de: "Gib deinen @Benutzernamen ein" },
  "ig.howItWorks.step1.desc": { fr: "On scanne ton profil Instagram et on analyse tes stats en quelques secondes.", en: "We scan your Instagram profile and analyze your stats in seconds.", es: "Escaneamos tu perfil de Instagram y analizamos tus stats en segundos.", pt: "Escaneamos seu perfil do Instagram e analisamos suas stats em segundos.", de: "Wir scannen dein Instagram-Profil und analysieren deine Stats in Sekunden." },
  "ig.howItWorks.step2.title": { fr: "Choisis tes packs", en: "Choose your packs", es: "Elige tus packs", pt: "Escolha seus pacotes", de: "Wähle deine Pakete" },
  "ig.howItWorks.step2.desc": { fr: "Sélectionne les followers, likes ou vues adaptés à tes objectifs.", en: "Select the followers, likes or views adapted to your goals.", es: "Selecciona los seguidores, likes o vistas adaptados a tus objetivos.", pt: "Selecione os seguidores, likes ou views adaptados aos seus objetivos.", de: "Wähle die Follower, Likes oder Views passend zu deinen Zielen." },
  "ig.howItWorks.step3.title": { fr: "Croissance rapide", en: "Fast growth", es: "Crecimiento rápido", pt: "Crescimento rápido", de: "Schnelles Wachstum" },
  "ig.howItWorks.step3.desc": { fr: "Résultats visibles en quelques heures. Livraison progressive et naturelle.", en: "Results visible in hours. Progressive and natural delivery.", es: "Resultados visibles en horas. Entrega progresiva y natural.", pt: "Resultados visíveis em horas. Entrega progressiva e natural.", de: "Ergebnisse in Stunden sichtbar. Progressive und natürliche Lieferung." },
  "ig.faq.q1": { fr: "Comment ça marche pour Instagram ?", en: "How does it work for Instagram?", es: "¿Cómo funciona para Instagram?", pt: "Como funciona para o Instagram?", de: "Wie funktioniert es für Instagram?" },
  "ig.faq.a1": { fr: "Entre ton pseudo Instagram, choisis tes packs (followers, likes, vues) et on s'occupe du reste. Livraison progressive sous 24-72h.", en: "Enter your Instagram username, choose your packs (followers, likes, views) and we handle the rest. Progressive delivery within 24-72h.", es: "Ingresa tu usuario de Instagram, elige tus packs (seguidores, likes, vistas) y nos encargamos del resto. Entrega progresiva en 24-72h.", pt: "Digite seu usuário do Instagram, escolha seus pacotes (seguidores, likes, views) e cuidamos do resto. Entrega progressiva em 24-72h.", de: "Gib deinen Instagram-Benutzernamen ein, wähle deine Pakete (Follower, Likes, Views) und wir kümmern uns um den Rest. Progressive Lieferung in 24-72h." },
  ...
  "ig.faq.a2": { fr: "Oui. Aucun mot de passe requis, aucun accès à ton compte. On a juste besoin de ton pseudo public.", en: "Yes. No password required, no access to your account. We just need your public username.", es: "Sí. Sin contraseña, sin acceso a tu cuenta. Solo necesitamos tu usuario público.", pt: "Sim. Sem senha, sem acesso à sua conta. Só precisamos do seu usuário público.", de: "Ja. Kein Passwort nötig, kein Zugang zu deinem Konto. Wir brauchen nur deinen öffentlichen Benutzernamen." },
  ...
  "ig.faq.a3": { fr: "Les premiers résultats sont visibles en quelques heures. Selon le pack choisi, tout est finalisé sous 24-72h.", en: "First results visible within hours. Depending on the pack chosen, everything is finalized within 24-72h.", es: "Los primeros resultados son visibles en horas. Según el pack, todo se finaliza en 24-72h.", pt: "Os primeiros resultados são visíveis em horas. Dependendo do pacote, tudo finalizado em 24-72h.", de: "Erste Ergebnisse in Stunden sichtbar. Je nach Paket ist alles in 24-72h abgeschlossen." },
  ...
  "ig.faq.a4": { fr: "On mise sur une croissance progressive et stable. En cas de variation, on compense gratuitement pendant 30 jours.", en: "We focus on progressive and stable growth. In case of variation, we compensate for free for 30 days.", es: "Apostamos por un crecimiento progresivo y estable. En caso de variación, compensamos gratis durante 30 días.", pt: "Apostamos em crescimento progressivo e estável. Em caso de variação, compensamos gratuitamente por 30 dias.", de: "Wir setzen auf progressives, stabiles Wachstum. Bei Schwankungen gleichen wir 30 Tage lang kostenlos aus." },
