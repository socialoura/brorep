...
const pages: Record<string, PageMeta> = {
  ...
  spotify: {
    title: {
      fr: "Promotion Spotify propulsée par l'IA — Portée virale, auditeurs réels",
      en: "AI-Powered Spotify Promotion — Viral Reach, Real Listeners",
      es: "Promoción Spotify potenciada por IA — Alcance viral, oyentes reales",
      pt: "Promoção Spotify com IA — Alcance viral, ouvintes reais",
      de: "KI-gestützte Spotify-Promotion — Virale Reichweite, echte Hörer",
    },
    description: {
      fr: "Notre IA cible de vrais auditeurs Spotify qui adorent ton style pour une portée virale naturelle. Paiement Stripe sécurisé, premiers résultats en 24-48h.",
      en: "Our AI targets real Spotify listeners who love your style for natural viral reach. Secure Stripe payment, first results in 24-48h.",
      es: "Nuestra IA dirige tu tema a oyentes reales de Spotify que aman tu estilo para un alcance viral natural. Pago Stripe seguro, primeros resultados en 24-48h.",
      pt: "Nossa IA direciona sua música a ouvintes reais do Spotify que amam seu estilo para alcance viral natural. Pagamento Stripe seguro, primeiros resultados em 24-48h.",
      de: "Unsere KI bringt deinen Track vor echte Spotify-Hörer, die deinen Stil lieben — für natürliche virale Reichweite. Sichere Stripe-Zahlung, erste Ergebnisse in 24-48h.",
    },
    keywords: {
      fr: ["promotion spotify ia", "portée virale spotify", "promotion musicale spotify", "campagne spotify ia", "marketing spotify artiste", "fanovaly spotify"],
      en: ["ai spotify promotion", "ai powered viral reach", "spotify music promotion", "spotify marketing", "ai music promotion", "fanovaly spotify"],
      es: ["promoción spotify ia", "alcance viral spotify", "promoción musical spotify", "marketing spotify ia", "campaña spotify", "fanovaly spotify"],
      pt: ["promoção spotify ia", "alcance viral spotify", "promoção musical spotify", "marketing spotify ia", "campanha spotify", "fanovaly spotify"],
      de: ["ki spotify promotion", "spotify virale reichweite", "spotify musikpromotion", "spotify marketing", "ki musikpromotion", "fanovaly spotify"],
    },
    ogTitle: {
      fr: "Promotion Spotify propulsée par l'IA — Fanovaly",
      en: "AI-Powered Spotify Promotion — Fanovaly",
      es: "Promoción Spotify potenciada por IA — Fanovaly",
      pt: "Promoção Spotify com IA — Fanovaly",
      de: "KI-gestützte Spotify-Promotion — Fanovaly",
    },
    ogDescription: {
      fr: "Notre IA cible de vrais auditeurs qui adorent ton style pour une portée virale naturelle.",
      en: "Our AI targets real listeners who love your style for natural viral reach.",
      es: "Nuestra IA dirige tu tema a oyentes reales que aman tu estilo para alcance viral natural.",
      pt: "Nossa IA direciona sua música a ouvintes reais que amam seu estilo para alcance viral natural.",
      de: "Unsere KI bringt deinen Track vor echte Hörer, die deinen Stil lieben — natürliche virale Reichweite.",
    },
    twitterTitle: {
      fr: "Promotion Spotify propulsée par l'IA — Fanovaly",
      en: "AI-Powered Spotify Promotion — Fanovaly",
