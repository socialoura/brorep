  ...
  return (
    <footer style={{ background: "#050505", borderTop: "1px solid rgba(255,255,255,0.04)", padding: "24px 20px", textAlign: "center" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "20px", flexWrap: "wrap", marginBottom: "8px" }}>
        <a href={href("/blog")} style={{ fontSize: "11px", color: "rgb(107, 117, 111)", textDecoration: "none" }}>Blog</a>
        <a href={href("/calculateur")} style={{ fontSize: "11px", color: "rgb(107, 117, 111)", textDecoration: "none" }}>{t("calc.freeToolTitle")}</a>
