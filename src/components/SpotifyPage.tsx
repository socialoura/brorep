...
function SpotifyPageInner() {
  ...
  if (step === "shop") {
    ...
    return shell(
      <div style={{ width: "100%", maxWidth: "480px", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px", paddingBottom: "120px" }}>
        ...
        {/* Packs title */}
        <p style={{ fontSize: "13px", fontWeight: 600, color: "rgb(169,181,174)", margin: 0, textTransform: "uppercase", letterSpacing: "0.05em" }}>
          {t("spotify.pickPack")}
        </p>

        {/* Packs grid */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px", width: "100%", maxWidth: "360px" }}>
          {(() => {
        ...
        <button
          ...
          style={{
            width: "100%", maxWidth: "360px", padding: "16px 0", borderRadius: "14px", border: "none",
    ...
    <>
      ...
      <div style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "32px 24px 40px", width: "100%", maxWidth: "672px", textAlign: "center", position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
          <img src="/logo-green.png" alt="Fanovaly" style={{ height: "192px", objectFit: "contain" }} />
          <h1 style={{ fontSize: "clamp(3.2rem, 12vw, 6.4rem)", fontWeight: 900, letterSpacing: "-0.02em", lineHeight: 1.1, textTransform: "uppercase", margin: 0, color: "#fff" }}>
      ...
      <div style={{ width: "100%", maxWidth: "540px", padding: "48px 24px 80px", display: "flex", flexDirection: "column", alignItems: "center", gap: "32px" }}>
