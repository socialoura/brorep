...
function TikTokIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: "16px", height: "16px", color: "rgb(105, 201, 208)" }}>
      ...
      >
        ...
        <div
          style={{
            ...
            border: `1px solid ${focused ? "rgba(105, 201, 208, 0.4)" : "rgba(105, 201, 208, 0.12)"}`,
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 8px 30px rgba(105, 201, 208, 0.25)",
            cursor: "pointer",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
